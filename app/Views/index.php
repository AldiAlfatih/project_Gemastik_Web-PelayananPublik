    ...
    <div class="landingpage">
        <div class="navbar">
            ...
            <div class="navlinkwrap">
                ...
                <span class="navlink">Edukasi</span>
                <span class="navlink">Barang</span>
                <span class="navlink">How It Works</span>
            </div>
            <div class="buttonwrap">
                <a href="/register"><button class="createbtn selectedbtn">CREATE</button></a>
                <a href="/login"><button class="createbtn">SIGN IN</button></a>
            </div>
        </div>
        <div class="box">
            <div class="infobox">
                <p class="infobox-boldtext">
                    Solusi Cerdas untuk Pengelolaan Sampah dan Lingkungan
                </p>
                <p class="infobox-slimtext">
                    Trash !ssue membantu Anda melaporkan sampah yang menumpuk, menyumbangkan barang layak pakai, menyediakan tempat mengambil barang masih layak pakai, dan memberikan edukasi tentang pengelolaan sampah yang baik.

                </p>
                <div class="infobox-btnwrapper">
                <a href="/login"><button class="infobox-explorebtn selected">Mulai Sekarang!!</button></a>
        ...
        <div class="footer2">
            <div></div>
            <p>Created by:<a href="https://github.com/AldiAlfatih/project_Gemastik_Web-PelayananPublik.git">BABAYAGA</a></p>
